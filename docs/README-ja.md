# How to use
Dashboardを起動したら、あなたの[venus912](https://github.com/venus912/venus912-python)をdashboardから管理することができます。バックエンドにKubernetesを用いる場合は、dashboardからKubernetesにあなたの機械学習サービスをdeployします。
