...
from venus912_dashboard.logger.logger_interface import SystemLoggerInterface
...
class DummySystemLogger(SystemLoggerInterface):
    ...
    def __init__(self, logger_name:str='venus912_dashboard', log_level:int=logging.NOTSET) -> None:
        """
        constructor
